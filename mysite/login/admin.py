...
from . import models
from login import asset_handler


class NewAssetAdmin(admin.ModelAdmin):
    list_display = ['user1', 'asset_type', 'sn', 'model', 'manufacturer', 'c_time', 'm_time']
    ...
    approve_selected_new_assets.short_description = '批准选择的新资产上线'

class AssetAdmin(admin.ModelAdmin):
    list_display = ['user1', 'asset_type', 'name', 'status', 'approved_by', 'c_time', "m_time"]
