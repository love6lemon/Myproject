...
class Asset(models.Model):
    ...
    user1 = models.ForeignKey('User1', verbose_name='资产所有者', related_name='user1', null=True, blank=True, on_delete=models.CASCADE)
...
class NewAssetApprovalZone(models.Model):
    ...
    user1 = models.ForeignKey('User1', verbose_name='资产所有者', related_name='user0', null=True, blank=True, on_delete=models.CASCADE)
